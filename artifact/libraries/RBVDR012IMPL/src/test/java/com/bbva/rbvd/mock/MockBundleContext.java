...
public class MockBundleContext implements BundleContext,
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("RBVDR012IMPL-0.1.1-SNAPSHOT");
		Mockito.when(mockBundle.getVersion()).thenReturn(new Version("0.1.1-SNAPSHOT"));
		return mockBundle;
	}
